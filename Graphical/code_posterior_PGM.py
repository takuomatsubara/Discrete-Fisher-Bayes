...
File_ID = "PGM_" + args.type + "_numdim=" + str(args.num_dim) + "_numchains=" + str(args.num_chains) + "_numsample=" + str(args.num_sample) + "_numboot=" + str(args.num_boot) + "_numpred=" + str(args.num_pred) + "_numpredsample=" + str(args.num_pred_sample)
